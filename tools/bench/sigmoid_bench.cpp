...
SIGMOID_BENCH (sigmoid_approx3, math_approx::sigmoid<3>)
SIGMOID_BENCH (sigmoid_approx2, math_approx::sigmoid<2>)
...
SIGMOID_BENCH (sigmoid_rsqrt_approx9, math_approx::sigmoid_rsqrt<9>)
SIGMOID_BENCH (sigmoid_rsqrt_approx7, math_approx::sigmoid_rsqrt<7>)
SIGMOID_BENCH (sigmoid_rsqrt_approx5, math_approx::sigmoid_rsqrt<5>)
