...
TRIG_BENCH (sinpi_ref, sincospi::sin2pi)
TRIG_BENCH (sinpi_approx9, math_approx::sin_turns<9>)
// TRIG_BENCH (sinpi_approx7, math_approx::sin<7>)
// TRIG_BENCH (sinpi_approx5, math_approx::sin<5>)
