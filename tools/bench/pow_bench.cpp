...
POW_BENCH (exp_approx2, math_approx::exp<2>)
POW_BENCH (exp_approx1, math_approx::exp<1>)
POW_BENCH (exp_approx1_no_clamp, (math_approx::exp<1, false, false>))
...
POW_BENCH (exp2_approx2, math_approx::exp2<2>)
POW_BENCH (exp2_approx1, math_approx::exp2<1>)
POW_BENCH (exp2_approx1_no_clamp, (math_approx::exp2<1, false, false>))
...
POW_BENCH (exp10_approx2, math_approx::exp10<2>)
POW_BENCH (exp10_approx1, math_approx::exp10<1>)
POW_BENCH (exp10_approx1_no_clamp, (math_approx::exp10<1, false, false>))
...
POW_SIMD_BENCH (exp_simd_approx2, math_approx::exp<2>)
POW_SIMD_BENCH (exp_simd_approx1, math_approx::exp<1>)
POW_SIMD_BENCH (exp_simd_approx1_no_clamp, (math_approx::exp<1, false, false>))
...
POW_SIMD_BENCH (exp2_simd_approx2, math_approx::exp2<2>)
POW_SIMD_BENCH (exp2_simd_approx1, math_approx::exp2<1>)
POW_SIMD_BENCH (exp2_simd_approx1_no_clamp, (math_approx::exp2<1, false, false>))
...
POW_SIMD_BENCH (exp10_simd_approx2, math_approx::exp10<2>)
POW_SIMD_BENCH (exp10_simd_approx1, math_approx::exp10<1>)
POW_SIMD_BENCH (exp10_simd_approx1_no_clamp, (math_approx::exp10<1, false, false>))
